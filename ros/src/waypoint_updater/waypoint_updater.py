...
PUBLISHING_RATE = 50 # Publishing frequency (Hz)
...
class WaypointUpdater(object):
    ...
    ***************************************************************************
    ...
    def publish_trajectory(self):
        ...
        while not rospy.is_shutdown():
            ...
            if( isWaypoints > 0 ):
                ...
                # STAGE 2. Populate waypoints trajectory buffer
    ...
    @ Brief
    ***************************************************************************
        This method is used to update the velocity in the waypoints path
    ***************************************************************************
    """
    def velocity_update(self, closer_waypoint,idx):
        ...
        if not self.loop and self.halt:
            ...
            distance_to_stopline = self.eucledien_distance( carpose.x,carpose.y,carpose.z,
                                                            ltpos.x,ltpos.y,ltpos.z)
    ...
    ***************************************************************************
    ...
    @ Brief
    ***************************************************************************
        Helper methot to stimate the eucldian distance
    ***************************************************************************
    """
    ...
    ***************************************************************************
    ...
    def pose_cb(self, msg):
        ...
        if not self.loop and (self.destination is not None):
            ...
            distance_to_destination = self.distanceDst(self.current_pose.pose.position,
                                                       self.base_waypoints.waypoints[sidx].pose.pose.position)
